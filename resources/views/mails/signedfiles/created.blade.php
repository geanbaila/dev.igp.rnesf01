                                        ...
                                        <div class="contentEditableContainer contentTextEditable">
                                            <div class="contentEditable">
                                                ...
                                                <p class="igp-text-color">
                                                    <strong>Entidad:</strong> {{ $signed->user->name }}
                                                </p>
                                                <p class="igp-text-color">
                                                    <strong>RUC:</strong> {{ $signed->user->ruc }}
                                                </p>

                                                <p class="igp-text-color">
                                                    <strong>Fecha de
                                                        subida:</strong> {{$signed->created_at->format('d/m/Y H:i')}}h
                                                </p>

                                                <p class="igp-text-color">
                                                    <strong>Nombre del archivo:</strong> {{$signed->nombre}}
                                                </p>
