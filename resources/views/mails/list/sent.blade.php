                                        ...
                                        <div class="contentEditableContainer contentTextEditable">
                                            <div class="contentEditable">
                                                <h2 style="height: 35px; text-align: center;" class="igp-text-color">
                                                    RECEPCIÓN DE LISTA {{ $lista->numero }}
                                                </h2>

                                                <p>&nbsp;</p>

                                                <p class="igp-text-color">
                                                    <strong>Entidad:</strong> {{ $lista->user->name }}
                                                </p>
                                                <p class="igp-text-color">
                                                    <strong>RUC:</strong> {{ $lista->user->ruc }}
                                                </p>

                                                <p class="igp-text-color">
                                                    <strong>Fecha de recepción:</strong> {{$lista->fecha_firma->format('d/m/Y H:i')}}h
                                                </p>
