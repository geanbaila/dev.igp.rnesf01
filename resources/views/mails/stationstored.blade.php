...
<head>
    ...
    <title>Nuevo archivo recibido</title>
    <style type="text/css">
        body {
        ...
        <td align='center' class='movableContentContainer'>
            ...
            <div class='movableContent'>
                <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                        <td height='10' bgcolor="0503AE"></td>
                    </tr>
                </table>
            </div>
                                        ...
                                        <div class="contentEditableContainer contentTextEditable">
                                            <div class="contentEditable">
                                                <h2 style="height: 35px; text-align: center;" class="igp-text-color">
                                                    NUEVA ESTACIÓN REGISTRADA {{ $estacion->numero }}
                                                </h2>

                                                <p>&nbsp;</p>
                                                <p class="igp-text-color">
                                                    <strong>Tipo:</strong> {{$estacion->tipo}}
                                                </p>

                                                <p class="igp-text-color">
                                                    <strong>Entidad:</strong> {{ $estacion->user->name }}
                                                </p>
                                                <p class="igp-text-color">
                                                    <strong>RUC:</strong> {{ $estacion->user->ruc }}
                                                </p>

                                                <p class="igp-text-color">
                                                    <strong>Fecha de registro:</strong> {{$estacion->created_at->format('d/m/Y H:i')}}h
                                                </p>
                                                ...
                                                {{--
                                                    <p style='text-align: right;'>
                                                        <a target="_blank" href="" class="igp-button">Ir a la aplicación</a>
                                                    </p>
                                                --}}
            ...
            <div class='movableContent'>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class='bgItem'>
                    <tr>
                        <td height='10' bgcolor="0200CF"></td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class='movableContent'>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class='bgItem'>
                    <tr>
                        <td style="background-color: #0200AE">
                            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
                                <tr>
                                    <td height='20'></td>
                                </tr>
                                        ...
                                        <div class="contentEditableContainer contentTextEditable">
                                            <div class="contentEditable">
                                                <p style='color:white;text-align:center;font-size:12px;line-height:19px;'>
                                                    {{-- Enviado por Módulo Bidireccional App<br> --}}
